    ...
    return ListView(children: <Widget>[
      ...
      Padding(
          ...
          child: Card(
              ...
              // Row(children: <Widget>[
              //   Expanded(
              //     child: Text("عدد المرات باليوم"),flex: 3
              //   ),
              //   Expanded(
              //     child: Padding(padding:EdgeInsets.all(5) ,child:TextField(
              //       decoration: new InputDecoration(
              //         focusedBorder: OutlineInputBorder(
              ...
              //   ),
              //   Expanded(
              //     child: Padding(padding:EdgeInsets.all(2),child:  TextField(
              //       decoration: new InputDecoration(
              //         focusedBorder: OutlineInputBorder(
              //           borderSide: BorderSide(color: Colors.greenAccent, width:1.0),
              //         ),
