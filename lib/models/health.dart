class Health {
  ...
  Health(this.name, this.note, this.tall, this.weight, this.tempreture, this.isActive, this.childId, this.createdDate);

  Health.map(dynamic obj){
    this.name = obj['name'];
    this.note = obj['note'];
    this.tall = obj['tall'];
  ...
  Health.fromeMap(Map<String,dynamic>map){
    this.name = map['name'];
    this.note = map['note'];
    this.tall = map['tall'];
